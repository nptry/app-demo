...
const basicInfoData = {
  ...
  devices: [
    ...
    },
    {
      ...
      model: 'GW-600',
      vendor: 'Didikon',
      serialNumber: 'GW600-202404-201',
      installDate: '2023-10-01',
      warrantyDate: '2026-09-30',
      status: '在线',
    },
    {
      id: 'DEV-GW-208',
      ...
      model: 'GW-600',
      vendor: 'Didikon',
      serialNumber: 'GW600-202404-208',
      installDate: '2023-12-15',
      warrantyDate: '2026-12-14',
      status: '故障',
      remark: '5 月 8 日检测到信号模块异常',
    },
    {
      id: 'DEV-AIE-010',
      name: 'AI 边缘节点-人行通道一期',
    ...
    },
    {
      ...
      model: 'GW-620',
      vendor: 'Didikon',
      serialNumber: 'GW620-202404-215',
      installDate: '2024-03-05',
      warrantyDate: '2027-03-04',
      status: '离线',
      remark: '等待电源恢复',
    },
  ],
...
const configInfoData = {
  ...
  applications: [
    ...
    {
      deviceId: 'DEV-GW-201',
      deviceName: '4G 无线网关-商业区 A',
      applicationType: '重点区域监测',
      region: 'Ikeja 商业区汇聚点',
      address: 'Allen 大道光纤汇聚机柜',
      coordinates: '6.601012, 3.346120',
      lampId: 'LAMP-IKJ-01',
      description: '为重点区域摄像机与 AI 节点提供无线回传',
      deployDate: '2023-10-01',
    },
    {
      deviceId: 'DEV-GW-215',
      ...
      lampId: 'LAMP-OSH-05',
      description: '备份回传与安保无线对讲接入',
      deployDate: '2024-03-05',
    },
  ],
};
...
const statusData = {
  ...
  statuses: [
    ...
    },
    {
      ...
      type: '4G 无线网关设备',
      realtimeStatus: '故障',
      signalStrength: '-115 dBm（弱）',
      uploadRate: '中断',
      lastHeartbeat: '2024-05-09 09:58:41',
      exception: '信号放大模块损坏，需更换硬件',
    },
    {
      deviceId: 'DEV-GW-201',
      deviceName: '4G 无线网关-商业区 A',
      type: '4G 无线网关设备',
      realtimeStatus: '在线',
      signalStrength: '-78 dBm（强）',
      uploadRate: '3.5 Mbps',
      lastHeartbeat: '2024-05-09 10:44:48',
    },
    {
      deviceId: 'DEV-AIE-010',
      deviceName: 'AI 边缘节点-人行通道一期',
    ...
    },
    {
      ...
      signalStrength: '—',
      uploadRate: '0 Mbps',
      lastHeartbeat: '2024-05-09 09:07:52',
      exception: '通道改造断电，等待恢复供电',
    },
  ],
};
